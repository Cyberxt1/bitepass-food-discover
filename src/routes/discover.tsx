    ...
    <>
      ...
      <main className="space-y-6 px-4 pt-4">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-warm p-5 text-white shadow-glow animate-slide-up">
          ...
          <div className="relative">
            ...
            <p className="mt-1 text-xs text-white/85">
              Turn on location to see restaurants around you.
            </p>
            {!coords && (
              <button
                type="button"
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-xs font-semibold text-foreground transition active:scale-95 disabled:opacity-70"
              >
        ...
        <section>
          ...
          {!coords && !loading && (
            <div className="mb-3 rounded-2xl border border-dashed border-border bg-card px-4 py-3 text-sm text-muted-foreground">
